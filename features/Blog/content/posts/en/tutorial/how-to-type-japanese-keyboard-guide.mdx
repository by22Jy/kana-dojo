...
| You Type   | Hiragana Result | Kanji Option |
| ---------- | --------------- | ------------ |
| watashi    | わたし          | 私           |
| tabemasu   | たべます        | 食べます     |
| konnichiwa | こんにちは      | -            |
...
| Key                               | Mode                | Example    |
| --------------------------------- | ------------------- | ---------- |
| **Hiragana key** or **Alt + `~`** | Hiragana            | あいうえお |
| **F7** (after typing)             | Convert to Katakana | アイウエオ |
| **Caps Lock** or **Shift**        | English letters     | AIUEO      |
| **F9** (after typing)             | Convert to romaji   | aiueo      |
...
| Shortcut                | Action                       |
| ----------------------- | ---------------------------- |
| **Control + Shift + J** | Convert to Hiragana          |
| **Control + Shift + K** | Convert to Katakana          |
...
| -------------- | -------------------- | ---------------- |
| っ (small tsu) | Double the consonant | `kitte` → きって |
| ゃ (small ya)  | `xya` or `lya`       | ゃ               |
| ゅ (small yu)  | `xyu` or `lyu`       | ゅ               |
| ょ (small yo)  | `xyo` or `lyo`       | ょ               |
...
| Japanese | How to Type             | English Equivalent |
| -------- | ----------------------- | ------------------ |
