...
| Vowel  | Sound | Mouth Position   | English Comparison |
| ------ | ----- | ---------------- | ------------------ |
| あ (a) | "ah"  | Wide open        | "father"           |
| い (i) | "ee"  | Spread, smiling  | "feet"             |
| う (u) | "oo"  | Relaxed, flat    | Unstressed "oo"    |
| え (e) | "eh"  | Medium open      | "bed"              |
| お (o) | "oh"  | Slightly rounded | Short "go"         |
...
| Pattern          | Word       | Pitch | Example    |
| ---------------- | ---------- | ----- | ---------- |
| 頭高 (Head-high) | 箸 (hashi) | HL    | chopsticks |
| 尾高 (Tail-high) | 橋 (hashi) | LH    | bridge     |
